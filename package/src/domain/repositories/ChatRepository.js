export class ChatRepository {
    async getChats(userId) { throw new Error("ChatRepository.getChats() not implemented"); }
    async getChatById(id, userId) { throw new Error("ChatRepository.getChatById() not implemented"); }
    ...
    async clearChats(userId) { throw new Error("ChatRepository.clearChats() not implemented"); }
